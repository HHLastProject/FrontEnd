...
export const KAKAO_CALLBACK_URL_VERCEL = "https://front-end-zeta-dusky.vercel.app/redirect/kakao"
...
export const KAKAO_AUTH_URL: string = `https://kauth.kakao.com/oauth/authorize?client_id=${KAKAO_CLIENT_ID}&redirect_uri=${KAKAO_CALLBACK_URL_VERCEL}&response_type=code&prompt=login`;
